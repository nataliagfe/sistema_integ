...
<body class="body">
    ...
    <div id="fundo">
        <div id="formulario">
            <h1>Notas</h1>
            <form action="notas_table.php" method="post">
            ...
            <select name="turma">
                ...
                $consulta = mysqli_query($conexao, "SELECT Cod_turma, Num_turma
            ...
            <select name="materia">
                ...
                $consulta = mysqli_query($conexao, "SELECT Cod_materia, Nome_materia
                FROM Materia ORDER BY Cod_materia");
